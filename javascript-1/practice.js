...
let me ={firstName:'Jeff',
			state: 'Utah',
			age: 29, 
			greeter: function hello(){return `Hello! My name is ${me.firstName} and I live in ${me.state}`},};
...
let doubled = myNumbers.map(function(num) {return num * 2});
